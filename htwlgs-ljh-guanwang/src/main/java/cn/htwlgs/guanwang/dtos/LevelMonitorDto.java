...
@Data
public class LevelMonitorDto extends IdDto{
    ...
    @ApiModelProperty(value = "所属管段编号",required = true)
    @ExcelProperty(value = "所属管段编号")
    @NotEmpty(message = "所属管段编号不能为空",groups = {InsertAttr.class, UpdateAttr.class})
    ...
    public LevelMonitorDto() {}

    public LevelMonitorDto(LevelMonitor item) {
