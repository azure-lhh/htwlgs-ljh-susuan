...
@ColumnWidth(15) //列宽
public class RainwaterSpotDto extends IdDto{
    @ApiModelProperty(value = "雨水管点名称",required = true)
    @ExcelProperty(value = "雨水管点名称")
    @NotEmpty(message = "雨水管点名称",groups = {InsertAttr.class, UpdateAttr.class})
    private String pipeName;

    @ApiModelProperty("雨水管点编号")
    @ExcelProperty(value = "雨水管点编号")
    ...
    @ApiModelProperty("雨水管点级别")
    @ExcelProperty(value = "雨水管点级别")
    private String level ;

    @ApiModelProperty("雨水管点长度")
    @ExcelProperty(value = "雨水管点长度")
    private BigDecimal length = BigDecimal.ZERO;

    @ApiModelProperty("雨水管点地址")
    @ExcelProperty(value = "雨水管点地址")
    ...
    @ApiModelProperty("雨水管点空间拓扑关系")
    @ExcelProperty(value = "雨水管点空间拓扑关系")
    private String relationship;

    @ApiModelProperty("雨水管点采集设备基础信息")
    @ExcelProperty(value = "雨水管点采集设备基础信息")
    private String equipment;

    @ApiModelProperty("雨水管点形状")
    @ExcelProperty(value = "雨水管点形状")
    private String shape;

    @ApiModelProperty("雨水管点内径")
    @ExcelProperty(value = "雨水管点内径")
    private BigDecimal within = BigDecimal.ZERO;

    @ApiModelProperty("雨水管点外径")
    @ExcelProperty(value = "雨水管点外径")
    private BigDecimal outside = BigDecimal.ZERO;

    @ApiModelProperty("雨水管点埋深")
    @ExcelProperty(value = "雨水管点埋深")
    ...
    @ApiModelProperty("雨水管点上游节点")
    @ExcelProperty(value = "雨水管点上游节点")
    private String upperNode;

    @ApiModelProperty("雨水管点下游节点")
    @ExcelProperty(value = "雨水管点下游节点")
    ...
    public RainwaterSpotDto() {
    }

    public RainwaterSpotDto(RainwaterSpot item) {
